...
const requiredMain = [
  'TAS v70.20.2 COMMERCIAL GATEWAY ONE-CLICK RELEASE', 'https://github.com/Bitme1972/tas.git', '[string]$ProjectName = "tas"',
  ...
  'Where-Object { $_.Name -ne ".git" }', 'push -u origin $Branch', 'DEPLOYMENT_MARKER_TAS_V70_20_2_COMMERCIAL_GATEWAY.txt',
  ...
  'editions/consultant/index.html', '$releaseFolders = @("src", "public", "functions", "scripts", "preview", "config", "editions", "release-assets")',
  ...
  'C:\\TAS\\TAS_v70_20_2_COMMERCIAL_GATEWAY'
];
...
if (!cmd.includes('TAS v70.20.2 COMMERCIAL GATEWAY')) throw new Error('CMD entry point is not labelled for v70.20.2.');
console.log('TAS v70.20.2 TAS-only Git, Cloudflare and independent-edition deployment runner gate passed.');
