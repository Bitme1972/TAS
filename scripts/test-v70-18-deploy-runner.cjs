...
const requiredMain = [
  'TAS v70.20.3 COMMERCIAL DELIVERY STUDIO ONE-CLICK RELEASE', 'https://github.com/Bitme1972/tas.git', '[string]$ProjectName = "tas"',
  ...
  'Where-Object { $_.Name -ne ".git" }', 'push -u origin $Branch', 'DEPLOYMENT_MARKER_TAS_V70_20_3_COMMERCIAL_DELIVERY.txt',
  'npm.cmd ci', 'npm.cmd run build', 'stash push --include-untracked', 'pull --ff-only',
  ...
  'config/edition-entitlements.json', 'editions/demo/index.html', 'editions/community/index.html', 'editions/professional/index.html',
  'editions/consultant/index.html', '$releaseFolders = @("src", "public", "functions", "scripts", "preview", "config", "editions", "release-assets", "demo-automation")',
  ...
  'demo-automation/record_tas_demo.py', 'demo-automation/RECORD_TAS_DEMO.cmd', 'demo-automation/requirements.txt',
  'C:\\TAS\\TAS_v70_20_3_COMMERCIAL_DELIVERY_STUDIO'
];
...
const forbidden = [
  ...
  'TAS_v70_19_COMMERCIAL_FOUNDATION', 'studio?v=70200'
];
...
if (!cmd.includes('TAS v70.20.3 COMMERCIAL DELIVERY STUDIO')) throw new Error('CMD entry point is not labelled for v70.20.3.');
console.log('TAS v70.20.3 TAS-only Git, Cloudflare and independent-edition deployment runner gate passed.');
